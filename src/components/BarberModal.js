...
//import { ServiceArea, ServiceInfo, ServiceName, ServicePrice } from '../screens/Barber/styles';
//import { UserAvatar, UserInfo } from '../screens/Barber/styles';
import Api from '../Api';
...
const TimeItem = styled.TouchableOpacity`
    ...
    border-radius: 10px;
`;
const TimeItemText = styled.ScrollView`
    font-size: 16px;
`;
...
export default ({ show, setShow, user, service }) => {
    ...
    useEffect(()=> {
        console.log("use.available", user.available);
                ...
                <ModalBody>
                   ...
                   <ModalItem>
                    ...
                    <FinishButton onPress={handleFinishClick}>
                        <FinishButtonText>Kết thúc đặt lịch ngày {selectedDay}</FinishButtonText>
                    </FinishButton>
